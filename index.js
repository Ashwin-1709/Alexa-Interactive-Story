...
const story = [
    ...
    /*29*/"\nEveryone rejoices and then heads aboard this ship. You promise yourself this isn’t gonna be your last time on Pluto and return to Earth. Congratulations! you have completed one of the possible endings! Congratulations, you have completed one of the possible endings! You may end up being wrong sometimes, but you should use it as motivation to improve, to try again and do better. If you want to play another storyline, just say, \"Restart the game\". Enjoy playing!",
